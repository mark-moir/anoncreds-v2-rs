...
*** TODO                                                       - update server and examples due to type changes
...
*** TODO tests/vca/zkp_functionality_tests/blind_signing_common.rs:130 - verify blind signing info correctness proof before signing
