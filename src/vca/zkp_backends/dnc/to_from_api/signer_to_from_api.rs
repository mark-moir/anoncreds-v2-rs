...
impl VcaTryFrom<(SignatureParamsG1<Bls12_381>, PublicKeyG2<Bls12_381>)>
    for api::SignerPublicSetupData
{
    fn vca_try_from(
        (sp, pk): (SignatureParamsG1<Bls12_381>, PublicKeyG2<Bls12_381>),
    ) -> VCAResult<api::SignerPublicSetupData> {
        Ok(api::SignerPublicSetupData(to_opaque_ark(
            &DncSignerPublicSetupData { sig_params: sp, pk },
        )?))
    }
}
