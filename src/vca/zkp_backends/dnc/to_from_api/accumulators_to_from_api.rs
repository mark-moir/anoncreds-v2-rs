...
impl VcaTryFrom<(Omega<G1>, Vec<Fr>, Vec<Fr>)> for api::AccumulatorWitnessUpdateInfo {
    fn vca_try_from(
        (o, a, r): (Omega<G1>, Vec<Fr>, Vec<Fr>),
    ) -> VCAResult<api::AccumulatorWitnessUpdateInfo> {
        let ap: Vec<String> = to_api(a)?;
        let rp: Vec<String> = to_api(r)?;
        Ok(api::AccumulatorWitnessUpdateInfo(to_opaque_json(&(
            o, ap, rp,
        ))?))
    }
}
...
impl VcaTryFrom<&api::AccumulatorWitnessUpdateInfo> for (Omega<G1>, Vec<Fr>, Vec<Fr>) {
    fn vca_try_from(
        x: &api::AccumulatorWitnessUpdateInfo,
    ) -> VCAResult<(Omega<G1>, Vec<Fr>, Vec<Fr>)> {
...
impl VcaTryFrom<(&VbaSetupParams<Bls12_381>, &VbaPublicKey<Bls12_381>)>
    for api::AccumulatorPublicData
{
    fn vca_try_from(
        x: (&VbaSetupParams<Bls12_381>, &VbaPublicKey<Bls12_381>),
    ) -> VCAResult<api::AccumulatorPublicData> {
        Ok(api::AccumulatorPublicData(to_opaque_json(&x)?))
    }
}

impl VcaTryFrom<&api::AccumulatorPublicData>
    for (VbaSetupParams<Bls12_381>, VbaPublicKey<Bls12_381>)
{
    fn vca_try_from(
        x: &api::AccumulatorPublicData,
    ) -> VCAResult<(VbaSetupParams<Bls12_381>, VbaPublicKey<Bls12_381>)> {
        from_opaque_json(&x.0)
    }
}
...
#[cfg(feature = "in_memory_state")]
impl VcaTryFrom<(&PositiveAccumulator<G1Affine>, &InMemoryState<Fr>)> for api::Accumulator {
    fn vca_try_from(
        (acc, ims): (&PositiveAccumulator<G1Affine>, &InMemoryState<Fr>),
    ) -> VCAResult<api::Accumulator> {
...
#[cfg(feature = "in_memory_state")]
impl VcaTryFrom<&api::Accumulator> for (PositiveAccumulator<G1Affine>, InMemoryState<Fr>) {
    fn vca_try_from(
        x: &api::Accumulator,
    ) -> VCAResult<(PositiveAccumulator<G1Affine>, InMemoryState<Fr>)> {
...
impl VcaTryFrom<(&VbaSetupParams<Bls12_381>, &VbaKeypair<Bls12_381>)> for api::AccumulatorData {
    fn vca_try_from(
        pair: (&VbaSetupParams<Bls12_381>, &VbaKeypair<Bls12_381>),
        ...
        Ok(api::AccumulatorData {
            accumulator_public_data,
            accumulator_secret_data,
        })
    }
}

impl VcaTryFrom<&api::AccumulatorData> for (VbaSetupParams<Bls12_381>, VbaKeypair<Bls12_381>) {
    fn vca_try_from(
        ad: &api::AccumulatorData,
    ) -> VCAResult<(VbaSetupParams<Bls12_381>, VbaKeypair<Bls12_381>)> {
        let api::AccumulatorData {
            accumulator_public_data,
            accumulator_secret_data,
        } = ad;
