//! The type aliases in this module and in [`crate::vca::interfaces::non_primitives`]
//! are designed to enable:
//!   - defining the types of record fields using them (e.g. the `specific_prover` field of
//!     [`crate::vca::interfaces::crypto_interface::CryptoInterface`] is defined to
//!     be of type `crate::vca::interfaces::primitives::SpecificProver`),
//!     and similarly, the `create_proof` field of [`crate::vca::api::VcaApi`]
//!     is defined to be `crate::vca::interfaces::non_primitives::CreateProof`
//!   - using them in the types of function definitions (e.g.
//!     [`crate::vca::r#impl::general::proof::create_proof`] takes a function of type
//!        `crate::vca::interfaces::primitives::SpecificProver` and returns a function
//!         of type `crate::vca::interfaces::non_primitives::CreateProof`
//!
...
//!     [`crate::vca::interfaces::non_primitives`].  (One example is
//!        [`crate::vca::r#impl::general::proof::create_proof`].)
...
//!     [`crate::vca::interfaces::crypto_interface::CryptoInterface`].
//!       - Because pointers require allocation on the heap, and a term
//!         (e.g., [`crate::vca::r#impl::ac2c::impl_ac2c::CRYPTO_INTERFACE_AC2C`]) of
//!         type [`crate::vca::interfaces::crypto_interface::CryptoInterface`]
...
pub type AccumulatorAddRemove = Arc<
    dyn Fn(
            ...
            &[AccumulatorElement],
        ) -> VCAResult<AccumulatorAddRemoveResponse>
        + Send
        + Sync,
>;
...
pub type CreateMembershipProvingKey = Arc<
    dyn Fn(
            Natural, // RNG seed
        ) -> VCAResult<MembershipProvingKey>
        + Send
        + Sync,
>;
