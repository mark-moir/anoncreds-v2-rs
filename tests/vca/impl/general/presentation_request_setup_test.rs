...
mod spec {
    ...
    mod get_proof_instructions {
        ...
        fn get_proof_instructions_for_range_proof() {
            ...
            let idxs_and_prf_instrs: Vec<(usize, &ProofInstructionGeneral<ResolvedRequirement>)> =
        ...
        fn check_cred_resolved_prf_instr(
            i: usize,
            instr: &ProofInstructionGeneral<ResolvedRequirement>,
        ) {
            // println!("check_cred_resolved_prf_instr {:?}", instr);
            match &instr.requirement {
        ...
        fn check_non_cred_resolved_prf_instr(
            all_pis: &[ProofInstructionGeneral<ResolvedRequirement>],
            i: usize,
            // instr: &ProofInstructionGeneral<ResolvedRequirement>,
        ...
        fn is_cred_resolved_for(
            ...
            i: usize,
            opt_instr: Option<&ProofInstructionGeneral<ResolvedRequirement>>,
        ) -> bool {
            match opt_instr {
