...
public class VerifyDecryptionRequest {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("proofReqs", "sharedParams", "dataForVerifier", "decryptionKeys", "decryptResponses", "nonce"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("proofReqs", "sharedParams", "dataForVerifier", "decryptionKeys", "decryptResponses", "nonce"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VerifyDecryptionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in VerifyDecryptionRequest is not found in the empty JSON string", VerifyDecryptionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VerifyDecryptionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `VerifyDecryptionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
