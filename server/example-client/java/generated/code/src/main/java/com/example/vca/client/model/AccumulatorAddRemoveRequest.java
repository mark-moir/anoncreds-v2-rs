...
public class AccumulatorAddRemoveRequest {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("accumulatorData", "accumulator", "additions", "removals"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("accumulatorData", "accumulator", "additions", "removals"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccumulatorAddRemoveRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AccumulatorAddRemoveRequest is not found in the empty JSON string", AccumulatorAddRemoveRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccumulatorAddRemoveRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AccumulatorAddRemoveRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("removals") == null) {
        ...
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `removals` to be an array in the JSON string but got `%s`", jsonObj.get("removals").toString()));
      }
  }
