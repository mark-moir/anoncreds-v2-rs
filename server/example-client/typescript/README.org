...
* BUG in VCA/typescript of DNC verify decryption
...
> example-vca-typescript-client@1.0.0 test /server/example-client/typescript
...
/server/example-client/typescript/src/vca/test/AppTest.ts:171
...
AssertionError: expected 'B64DecodeError(InvalidByte(0, 34))' to equal 'General("specific_verify_decryption_a…'
    at checkAC2CVerifiableEncryptionException (/server/example-client/typescript/src/vca/test/AppTest.ts:171:10)
    at /server/example-client/typescript/src/vca/test/AppTest.ts:394:19
